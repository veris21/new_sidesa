...
<div class="row" style="color:black;">        
        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-footer">
                <a target="__blank" href="https://www.google.com/maps/search/?api=1&query=<?php echo $koordinat['lat'].','.$koordinat['lng']; ?>" class="btn btn-default btn-lg btn-block">Tampilkan Lokasi Pada Peta <i class="fa fa-3x fa-map-o"></i></a>
                </div>
            </div>
        </div>
</div>
